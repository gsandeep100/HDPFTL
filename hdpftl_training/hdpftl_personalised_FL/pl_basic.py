...
def forward_pass(devices_data, edge_groups, le, num_classes, X_finetune, y_finetune,
    ...
    return device_models, edge_models, edge_outputs, theta_global, residuals_devices, residuals_edges, \
           y_global_pred, device_embeddings, y_global_true, global_acc
...
if __name__ == "__main__":
    ...
    for epoch in range(config["epoch"]):
        # Forward pass
        device_models, edge_models, edge_outputs, theta_global, residuals_devices, residuals_edges, \
            y_global_pred, device_embeddings, y_global_true, global_acc = (
            forward_pass(devices_data, edge_groups, le, num_classes, X_finetune, y_finetune,residuals_devices=residuals_devices,device_models=device_models
        ))
